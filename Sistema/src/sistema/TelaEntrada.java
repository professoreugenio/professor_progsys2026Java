...
public class TelaEntrada {
    ...
    public static void main(String[] args) {
        ...
        // Criando o botão para abrir a TelaSistema
        JButton botaoAbrirSistema = new JButton("Entrar no Sistema");
        botaoAbrirSistema.setFont(new Font("Arial", Font.BOLD, 16));

        // Ação do botão
        botaoAbrirSistema.addActionListener(e -> {
            TelaSistemaComMenu.main(new String[] {});
            tela.dispose(); // Fecha a tela de entrada
        });

        // Painel para o botão
        JPanel painelBotao = new JPanel();
        painelBotao.setBorder(BorderFactory.createEmptyBorder(10, 0, 30, 0));
        painelBotao.add(botaoAbrirSistema);

        // Painel central com imagem e botão
        JPanel painelCentro = new JPanel(new BorderLayout());
        painelCentro.add(imagemLogo, BorderLayout.CENTER);
        painelCentro.add(painelBotao, BorderLayout.SOUTH);

        // Adicionando os painéis na tela
